...
\begin{abstract}
  ...
  timescale in sub-adabatically or stably stratified disks.  
  ...
  opacity. We find the MMSN is unstable to the VSI from $\sim 5$AU to $\sim 50$AU
  with a characteristic growth time of $\sim 30$ local orbital periods. 
  ...
  outer of protoplanetary disks at tens of AU. 
\end{abstract}
