...
\begin{abstract}
  ...
  timescale. A quantitative assessment of the thermodynamic
  requirement for the VSI is thus desirable for application to
  realistic disks. To this end,  
  ...
  varying $\beta$. We find increasing $\beta$ away from zero
  dramatically reduces VSI growth rates because this generally
  introduces a strongly stabilizing vertical entropy gradient. Our
  linear calculations are consistent with previous hydrodynamic
  simulations. For vertically isothermal disks, we quantify `fast' 
  ...
  suggests the VSI is dynamically important in the outer parts of
