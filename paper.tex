...
\end{align}
which is Eq.  47 of \cite{urpin03}. %This result is far from rigorous, but it contains some useful insights.
...
height $|z|=\gamma H/2$. %i.e., at $z=O(H)$  
...
lengthscale. Furthermore, while we do not include viscosity in our
idealized disk models, in reality small-scale perturbations will be 
prone to viscous damping, and should drive weaker transport. 
