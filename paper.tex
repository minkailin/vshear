...
that temperature flucations decay rapidly (i.e. isothermal perturbations), then 
...
vertical shear is rather weak because $|\p_z\Omega|\propto \epsilon
\ll 1$. Then even a small amount of buoyancy can significantly
stabilize the VSI. It follows that $t_c$ must be quite short to permit
instability. 
...
$z$ dependence. We find that \emph{in a thin 
