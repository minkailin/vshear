...
disks which do not support the MRI \citep{gammie96,landry13}. In fact,
state-of-the-art  numerical simulations suggest portions of PPDs
remain laminar. %transport by wind, large-scale field 
% cite bai, lesur,
% gressel 

In this respect, purely hydrodynamical turbulence remains of interest
in the context of PPDs. One possibiliy is the vertical shear
instability (VSI), which has recently been demonstrated through
hydrodynamical simulations \citep{nelson13} %and kley simulations 


%stuff about vsi 
The VSI is an axisymmetric instability in three-dimensional (3D) disks
for which the rotation frequency $\Omega$ depends on the height from
the disk midplane. 
