...
\begin{align*}
  \beta \simeq 0.042
\end{align*}
at $r=30\mathrm{AU}$. This indicates the disk supports the fundamental
isothermal VSI, but only marginally. Using the above value of $\beta$,
MMSN disk parameters and $\khat=20$ in our linear code, we find a
growth rate of 
\begin{align*}
  \nu = 3.3\times10^{-3}\Omega_k.
\end{align*}
This corresponds to a characteristic growth time of $t_g\sim 50$
orbits. In fact, this mode was found to be the most unstable for
$\khat=20$. 
% and
...
3.6\times10^{-3}\Omega_k$, i.e. only slightly faster than that above. 
However, the eigenfunctions for large $\khat$ were found to have large
amplitude oscillations near the vertical boundaries. 
