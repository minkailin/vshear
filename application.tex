...
equation used in our calculations (Eq. \ref{lin_energy}), we identify 
...
40$ orbits. However, growth rates are weakly depedent on $\khat$ for
$10\lesssim \khat 60$ so this may be taken as a representative growth
rate of the fundamental VSI in the MMSN at $r=50\mathrm{AU}$. The
...
calculation above with $\beta\to\tilde{\beta}$. 
