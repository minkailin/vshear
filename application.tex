...
We therefore take Fig. \ref{mmsn_overall} as a representation of the
...
decreases as the disk generally becomes optically
thick. 
...
Fig. \ref{mmsn_overall} show stabilization inside $\sim 8$AU. % The mode
% operates interior to the expected minimum radius, 
...
all $z$: we find $t_\mathrm{grow}\sim 40P_\mathrm{orb}$ at $r=50$AU,
but $t_\mathrm{grow}\sim 400P_\mathrm{orb}$ at $r=5$AU. 
