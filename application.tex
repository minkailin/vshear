...
for $|z|\gtrsim1.25H$. In fact, we also find the VSI at $r=5$AU, but
with much reduced growth rates (when scaled by the local rotation).    
...
that it is the most unstable, except for the appearence of some
...
\beta_\mathrm{crit}$ away from the midplane. %because of fundamental mode
