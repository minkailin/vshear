...
% \emph{For this section. There are 3 main ideas, and I think they should be the subsections, more comments related to this are in the text itself}:
% \begin{itemize}
% \item Developing the cooling model in opt thin and this regimes, including MMSN value
% \item Comparison to expected $\beta_{crit}$
% \item Linear growth with MMSN cooling law
% \end{itemize}

% \emph{Suggested edits for this intro}
% \begin{itemize}
...
\subsubsection{A model for combined thermal relaxation}\label{toy_relax}
...
% \emph{This paragraph currently merely copies the figure caption, which is a waste and not illuminating to read.  Better to give some description of what the figure is showing. (see below for ideas)}\\
