...
\item We consider inertial waves with eigenfrequencies such that
  $|\upsilon^2|\ll \kappa^2,\,\Omega^2$ \citepalias{barker15}. We call
  this the low-frequency approximation. 

\item We are mainly interested in the effect of vertical shear, 
%  i.e. $q\neq
%  0$ for vertically isothermal disks. 
