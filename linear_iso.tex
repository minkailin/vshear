\section{Analytical discussion of vertically isothermal disks}\label{analytical}
...
($\gamma\equiv1$ and any value of $t_c$, or any value of $\gamma$ with
$t_c = 0$) and adiabatic perturbations ($\gamma\neq 1$ and
$t_c\to\infty$), before considering the effect of thermal relaxation. 
...
$\beta=0$. In this case Eq. \ref{ode_Q} implies 
\begin{align}
  Q = W, 
\end{align}
 and so 
