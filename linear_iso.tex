...
% obtain an equation for $\delta v_z$.  
...
\end{align}
where $\hat{\omega}$ and $\hat{\sigma}$ are real. 
...
which $h\ll 1$. Then we may write $\rho/\rho_0\simeq
...
\end{align}
and $\chi =
\left(1-\ii\hat{\zeta}\beta\right)/\left(1-\ii\hat{\zeta}\beta\gamma\right)
...
are employed by \citetalias{nelson13} and \citetalias{barker15}. However, all of
