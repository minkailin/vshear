...
%   developed by \cite{mcnally14}, which is an extension to the standard
%   shearing box \citep{goldreich65} background shear flows that are
%   height dependent.  As in the standard shearing box, in the VGSB the equilibrium disk
%   structure is assumed to be homogeneous in the radial ($x$) direction.  
...
% in which explicit dependences on the background radial disk structure
%   in Eq. \ref{lin_mass}---\ref{lin_energy} are neglected by setting
%   $\hat{g}_c=0$. 

% However, the global radial temperature structure,
%   which gives rise to vertical shear, is retained. 
