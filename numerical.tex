...
% {\bf big gamma larger than 1 but equal to small gamma, with tcool} 

% \subsection{Non-uniform thermal relaxation} 
% {\bf variable tcool, large at midplane, small in atmosphere. simplest
%   model is to multiply tcool by background density} 