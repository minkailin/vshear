...
% on results most relevant to our eventual application to protoplanetary disks. 

% The reader is referred
% to the above works for a detailed look at different VSI modes. Here,
% we present selected results most relevant to our eventual application
...
Fig. \ref{compare_eigenvz_vnoniso_kx100}
