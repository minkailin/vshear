...
appears at the same position in all cases. 
...
% They have lower growth rates than modes consistent with our
...
As explained by \cite{barker15}, the occurence of surface modes in the
...
%refer the reader to BL15 for surface modes 
...
an upper limit to the thermal timescale that allows the VSI. We thus
...
$\epsilon\in[0.02,0.1]$ separately. We consider the fundamental
corrugation mode for which $\beta_\crit$ is the actual critical
thermal timescale.%  We use $\khat=10$ to avoid complications to our
