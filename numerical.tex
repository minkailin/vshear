...
5H$). 
%\emph{not a clear and possible not valid argument.  All modes are associated with
%a BC and the disappearance of a mode for smaller zmax could be the artificial effect.}
%If we discard modes associated with boundary conditions, then
