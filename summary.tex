...
\end{align}
% We see that convective overstability is generally slower 
% than the VSI because $\nu_\mathrm{conv,max} = O(\epsilon^2\Omega_k)$,
% whereas the maximum VSI growth rate is $O(\epsilon\Omega_k)$. 
...
\S\ref{numerical} do satisfy $N_r^2<0$. %show early result
...
% Nevertheless, it will be important to expand the parameter space covered in
% this study to include convective overstability,

%self-consistence may require radially global disk models
