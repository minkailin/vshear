...
\subsection{Limiting form with real frequencies and $\khat\gg 1$}\label{disp_neut_limit}
...
\begin{align}
  &0 =M(M+1) + 4\beta\epsilon q M(M+1)\left(\hat{\omega}\khat\right) 
 +\left[1 +
 ...
 + 2\epsilon q \gamma\beta \left(\hat{\omega}\khat\right)^3 -  \left(\hat{\omega}\khat\right)^4 
  ...
  \left(\hat{\omega}\khat\right)^2,\label{relax_cond1} \\
   &0= \epsilon q M (M+1)\khat +
