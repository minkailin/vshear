...
Here we show that, under appropriate conditions, the maximum critical 
...
$\mathrm{max}(\beta_c)$ occurs at $M=0$. For fixed $\khat$ the
condition $\theta\leq 1$ can be satisfied in sufficiently thin disks.
This means that if $\beta>\beta_c(M=0)\equiv\beta_\mathrm{crit}$, then
all such modes will be stabilized. 
