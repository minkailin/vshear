...
\begin{align}\label{iso_ode3}
  W^{\prime\prime} - \left(1 + \frac{\ii qh \hat{k}}{1-\hat{\sigma}^2}\right)\hat{z}W^\prime  +
...
\begin{align}
  \hat{\sigma}^2 \simeq L\left(\frac{1+\ii q h
...
%   \hat{\sigma}^2 = L\left(\frac{1+\ii q h
