\section{Limitations of the vertically global shearing box}\label{global_corr}
Here, we discuss the relation between the linear problem in the
VGSB framework and the global linear problem.

 This procedure produces $\phi$ and $z$ momentum equations
...
It is interesting to note that there is a thermal relaxation timescale
...
\subsection{Spurious growth of adiabatic perturbations in the local
