...
{\bf However, large growth rates would invalidate the low-frequency approximation.} 
...
For fixed $\khat$ the condition $\theta\leq 1$ can be satisfied in sufficiently thin disks.
