...
\end{align}
We can eliminate $\delta v_\phi$ from these equations to obtain
\begin{align}
...
disks. Recalling $j=r^2\Omega$ and $r\p_z\Omega^2 = -\p_z\ln{\rho}\p_r
c_s^2$  for a vertically isothermal disk, we obtain 
\begin{align}
  \sigma^2\int \rho\left(|\delta v_r|^2 + |\delta v_z|^2\right) dV =
