...
(\S\ref{application}).  %Their importance is highlighted 
...
$\beta$ that allows the VSI for modes with $\khat^2\gg M+1$.  
% which, as we will find, correspond to low frequency
% modes. 
...
stability and $\khat^2\gg 1$. We consider modes with $M=0$ (the
...
in fact be obtained without assuming $|\epsilon q \khat|\ll 1$.  We
will confirm Eq. \ref{iso_vsi_cond} numerically in \S\ref{bcrit_num_test}.

Eq. \ref{bcrit_gen} suggests that as the thermal timescale is
