...
approximate solution for the frequency if $4M(M+1)|hq\khat|^2/(2M+1)^2\lesssim
1$, 
\begin{align}
...
% hold for higher order vertical modes when radial wavelengths are not
% too short. 
...
\end{align}
% but the correction term ($O(M |h q \khat|^2)$) is now suppressed.    
