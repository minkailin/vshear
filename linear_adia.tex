...
$\hat{\omega}$ and $\beta$.  
% Since our discussion of stable solutions without vertical shear yield
% a dispersion relation $\hat{\omega}\propto \khat^{-1}$ for $\khat\gg
% 1$ (\S\ref{iso_stable}, Eq. \ref{iso_stable_disp}).
