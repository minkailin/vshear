...
$\epsilon=0.05$, $q=-1$ and $\gamma=1.4$. Consistent with the previous
discussion, for $\beta\to0$ thermal relaxation has no effect as
$k_x\to0$ or $k_x\to\infty$. 

Fig. \ref{relax_disp_fig} shows that a growing fundamental VSI mode
exists both in the isothermal ($\beta\to0$) and adiabatic
($\beta\to\infty$) limits, although the latter growth rates are
significantly smaller and perturbations are restricted to the
midplane. However, for $0.1 \lesssim \beta\lesssim
\beta 30$, this mode is stabilized for $k_xH_\mathrm{iso}\gtrsim
10$. Although results for small $k_x$ violates the low-frequency
approximation, Fig. \ref{relax_disp_fig} suggests that thermal
relaxation needs to be significantly shorter than the dynamical time
in order for the VSI with appreciable growth rates to develop.
