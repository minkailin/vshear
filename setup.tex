...
The growth of the VSI is strongest for short radial wavelengths, as compared
 ...
 i.e.\
 \begin{align}
  \delta\rho \rightarrow \delta\rho(z)\exp{\left(\ii k_x x - \ii\zeta
      t\right)},    
\end{align}
...
gradients suc as $\p \Omega/ \p z$, refer to  equilibrium values at $(r_0, z)$.
...
\begin{align}
  \ii\zeta \frac{Q}{c_s^2}  &=  \ii k_x \delta v_x + \frac{d\dd
    v_z}{dz} + \frac{\p\ln{\rho}}{\p z}\delta v_z + \ksi
  \frac{\p\ln{\rho}}{\p r} \delta v_x,\label{lin_mass}\\
  \ii\zeta \delta v_x  &= \ii k_x W - 2\Omega\delta v_y -
  \ksi\frac{1}{\rho}\frac{\p P}{\p r}\frac{Q}{c_s^2}\label{lin_vx}\\
  ...
  \ksi\frac{1}{\rho}\frac{\p P}{\p r}\delta v_x.\label{lin_energy}
...
are presented in \S\ref{numerical} and \S\ref{application}.   The coefficient $ \ksi = 1$ is 
introduced simply to label terms with radial gradients of the equilibrium state, 
...
%form 
%\begin{align}
%  \rho \to \rho(r, z) + \delta\rho(r,z)\exp{\left(\ii k_rr - \ii\zeta
%      t\right)},    
%\end{align}
...
%     z}\left(\rho\delta v_z\right)  + \ksi\frac{\p\rho}{\p r}\delta v_r,\label{full_mass1}\\
%   \ii\zeta\delta v_r &= \frac{1}{\rho}\frac{\p\delta P}{\p r} - 2\Omega
%   \delta v_\phi - \ksi\frac{\delta\rho}{\rho^2}\frac{\p P}{\p r},\\ 
...
%     \frac{P}{\rho}\delta\rho\right) + \ksi \frac{\p P}{\p r}\delta v_r,\label{full_energy1}
% \end{align}
...
% ignored.       
%Then writing $\delta P /\rho \equiv W$ and $c_s^2\delta\rho/\rho\equiv Q$, the
