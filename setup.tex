\section{Governing equations and disk models}
...
In order to emphasize on the radially-local approximation, we
...
Eq. \ref{lin_mass}---\ref{lin_vz} will form the basis of our numerical
