...
for midplane density and temperature, respectively. We consider $q<0$
without loss of generality.  The polytropic index $\Gamma$ 
...
\end{align} 
implies stability. For typical model parameters, 
Eq. \ref{solberg2} indicates that axisymmetric instability in the adiabatic limit  
requires $\gamma < \Gamma + O( h^2)$, corresponding to a small entropy 
gradient.  
%This implies the equilibrium
%disk must have a small 
%entropy gradient in order to be unstable to axisymmetric adiabatic
%perturbations. 
This is generally not true for passively irradiated, stably
