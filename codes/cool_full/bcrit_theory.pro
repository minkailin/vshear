...
pro bcrit_theory, eps=eps, smallq=smallq, gmma=gmma, krange=krange, legend=legend, mmode=mmode, yrange=yrange, xrange=xrange, label=label
...
print, 'b0,om0', b0, om0
  ...
  plot, kaxis, bvals,xmargin=[8.2,1.8],ymargin=[3.5,2] $
        ,ytitle=textoidl('\beta'),xtitle=textoidl('k_xH_{iso}') $
  ...
  oplot, [kaxis(0),kaxis(nk-1)], abs(eps*smallq)/(gmma-1d0)*[1,1],  linestyle=1,thick=4; asymptotic limit for fund iso vsi
